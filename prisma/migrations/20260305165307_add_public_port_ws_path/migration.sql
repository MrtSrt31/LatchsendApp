...
CREATE TABLE "new_SystemSettings" (
    "publicPort" INTEGER NOT NULL DEFAULT 443,
    "wsPath" TEXT NOT NULL DEFAULT '/ws',
...
INSERT INTO "new_SystemSettings" ("adminBypassFileTypeRules", "allowGuestLocalShare", "allowedExtensions", "autoDeleteEnabled", "baseUrl", "createdAt", "defaultLanguage", "defaultLinkTtlHours", "defaultUserMaxUploadBytes", "id", "installed", "siteName", "storageQuotaBytes", "updatedAt", "usedStorageBytes") SELECT "adminBypassFileTypeRules", "allowGuestLocalShare", "allowedExtensions", "autoDeleteEnabled", "baseUrl", "createdAt", "defaultLanguage", "defaultLinkTtlHours", "defaultUserMaxUploadBytes", "id", "installed", "siteName", "storageQuotaBytes", "updatedAt", "usedStorageBytes" FROM "SystemSettings";
